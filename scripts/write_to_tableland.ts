...
async function main() {
  console.log("start");
  //const provider = new ethers.providers.InfuraProvider(process.env.SEPOLIA_RPC_URL, process.env.NEXT_PUBLIC_INFURA_API_KEY);
  ...
  //const provider = getDefaultProvider(process.env.SEPOLIA_RPC_URL, {infura: process.env.NEXT_PUBLIC_INFURA_API_KEY});
